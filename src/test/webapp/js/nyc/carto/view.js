...
QUnit.test('symbolize (has outlierFilter, 5 bins returned)', function(assert){
	...
	symbolizer.symbolize(this.MOCK_LAYER);
	...
	assert.equal(this.MOCK_LAYER.css, '#carto_css{}#rule5[5]{}#rule4[4]{}#rule3[3]{}#rule2[2]{}#rule1[1]{}'); 
});
...
QUnit.test('symbolize (no outlierFilter, 4 bins returned)', function(assert){
	...
	assert.equal(this.MOCK_LAYER.css, '#carto_css{}#rule4[4]{}#rule3[3]{}#rule2[2]{}#rule1[1]{}'); 
});
...
QUnit.test('update (has symbolizer)', function(assert){
	...
	assert.deepEqual(this.MOCK_SYMBOLIZER.layer, this.MOCK_LAYER);
...
QUnit.test('visibility', function(assert){
	...
	var view = new nyc.carto.View({layer: this.MOCK_LAYER});
	
	view.visibility(true);
	assert.equal(this.MOCK_LAYER.showHide, 'show');
	view.visibility(false);
	assert.equal(this.MOCK_LAYER.showHide, 'hide');
});
